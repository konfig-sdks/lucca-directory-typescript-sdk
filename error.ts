...
/**
 * This class provides a wrapper for network errors when making requests to Directory-v3
 */
export class LuccaDirectoryError extends Error {
  /**
   * The response body
   */
